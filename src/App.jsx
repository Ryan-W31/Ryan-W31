    ...
    <div className="font-mono">
        ...
        <div class="flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a href="#about" class="block py-2 px-3 rounded text-light-primary hover:text-light-secondary">
                  About
                </a>
              </li>
              <li>
                <a href="#exp" class="block py-2 px-3 rounded text-light-primary hover:text-light-secondary">
                  Experience
                </a>
              </li>
              <li>
                <a href="#proj" class="block py-2 px-3 rounded text-light-primary hover:text-light-secondary">
                  Projects
                </a>
              </li>
              <li>
                <a href="#contact" class="block py-2 px-3 rounded text-light-primary hover:text-light-secondary">
                  Contact
                </a>
              </li>
            </ul>
      ...
      >
        ...
        <div class="flex flex-col items-center justify-center w-1/2 p-12">
          <h1 class="text-6xl font-bold text-light-primary mb-4">A little about me...</h1>
          <ul className="text-light-primary text-left text-xl space-y-4">
            <li>
              &#127891; I'm currently a Software Engineer at Apple in Austin, TX. I graduated from the University
              of Central Florida with a B.S. in Computer Science.
            </li>
            <br />
            <li>
      ...
      <section id="exp" className="m-12 bg-dark-secondary rounded-lg border-light-secondary border-2 scroll-mt-24">
        <div>
          <h1 class="text-6xl font-bold text-light-primary text-center my-4">Experience</h1>
        ...
        <div className="flex flex-col justify-center items-center space-y-4 m-8 p-8 rounded-lg bg-dark-primary border-light-secondary border-2">
          ...
          <p class="text-light-primary text-center">Software Engineer</p>
          <p class="text-light-secondary text-center">January 2025 - Present</p>
          <ul class="text-light-primary text-center space-y-2">
            <li>
              - Developed ingestion services for Apple’s internal generative AI platform, powering RAG workflows
              used by over <b className="text-light-secondary">200</b> internal applications.
            </li>
            <li>
        ...
        <div className="flex flex-col justify-center items-center space-y-4 m-8 p-8 rounded-lg bg-dark-primary border-light-secondary border-2">
          ...
          <p class="text-light-primary text-center">Data and Analytics Intern</p>
          <p class="text-light-secondary text-center">June 2023 - August 2023</p>
          <ul class="text-light-primary text-center space-y-2">
            <li>
              - Developed a classification model to assist sales representatives in identifying favorable customer
              interactions.
            </li>
      ...
      <section
        id="proj"
        className="m-12 bg-dark-secondary rounded-lg border-light-secondary border-2 scroll-mt-24"
      >
        <div>
          <h1 class="text-6xl font-bold text-light-primary text-center my-4">Projects</h1>
          <p class="text-light-primary text-center text-xl p-2">
        ...
        >
          ...
          <p class="text-light-primary text-xl text-center">Python | PyTorch | Jupyter Notebook</p>
          <ul class="text-light-primary text-center space-y-2">
            <li>
              - Built a <b className="text-light-secondary">124M+</b> parameter GPT-2 clone based on OpenAI's GPT-2
              model.
            </li>
            <li>
              - Implemented the <b className="text-light-secondary">10B</b> token Hugging Face FineWeb-Edu dataset
              for training.
            </li>
            <li>- Leveraged the PyTorch library for efficient use of CUDA and distributed parallel processing.</li>
          </ul>
        </a>
        <a
          className="flex flex-col justify-center items-center space-y-4 m-8 p-8 border-light-secondary border-2 bg-dark-primary rounded-lg"
          href="https://qbxr.net"
        >
          <h1 class="text-4xl font-bold text-light-primary">QBxR: NFL Quarterback Rating System</h1>
        ...
        >
          ...
          <p class="text-light-primary text-center text-xl">Python | NEAT-Python | pygame | NumPy | SciPy</p>
          <ul class="text-light-primary text-center space-y-2">
            <li>
              - Utilized the NeuroEvolution of Augmenting Topologies (NEAT) evolutionary algorithm to autonomously
              drive a virtual car around a racetrack.
            </li>
            <li>
              - Implemented Git for version control, ensuring an efficient and organized development process.
            </li>
          </ul>
        </a>
        <a
        ...
        >
          <h1 class="text-4xl font-bold text-light-primary">PL/0 Virtual Machine</h1>
          <p class="text-light-primary text-center text-xl">C</p>
          <ul class="text-light-primary text-center space-y-2">
            <li>
              - Designed and implemented a PL/0 compiler using C, complete with a syntax parser and code generator.
            </li>
            <li>
      ...
      <section id="contact" class="scroll-mt-24">
        <div class="flex flex-col items-center justify-center bg-dark-secondary border-2 border-light-secondary m-8 p-8 rounded-lg space-y-4">
          ...
          <p class="text-light-primary text-center w-1/2">
            ...
            <a href="mailto:ryan.weisman.512@gmail.com" className="text-light-secondary">
          ...
          <p class="text-light-primary text-center w-1/2">
            ...
            <a href="https://www.linkedin.com/in/ryanweisman/" className="text-light-secondary">
              LinkedIn
            </a>{" "}
            and{" "}
            <a href="https://github.com/Ryan-W31" className="text-light-secondary">
              GitHub
            </a>
            .
          </p>
          <p class="text-light-primary text-center w-1/2">
            Thanks for stopping by! Here are some of my favorite photos I've taken:
          </p>
          <div className="flex flex-row space-x-4 items-center justify-center">
            <figure className="w-1/3 h-auto">
              ...
              />
              <figcaption className="text-light-primary text-center">Nassau, The Bahamas</figcaption>
            </figure>
            <figure className="w-1/3 h-auto">
              <img className="rounded-lg border-2 border-light-secondary" src="../Ryan-W31/IMG_0624.JPG" />
              <figcaption className="text-light-primary text-center">Henderson, NV (Hometown)</figcaption>
            </figure>
            <figure className="w-1/3 h-auto">
              <img className="rounded-lg border-2 border-light-secondary" src="../Ryan-W31/_MG_9862.jpg" />
              <figcaption className="text-light-primary text-center">Chimney Rock, NC</figcaption>
            </figure>
          </div>
        </div>
      </section>
